...
export default function WhyUs() {
  ...
  return (
    <section className="relative section-padding overflow-hidden" style={{ background: 'linear-gradient(135deg, #fdf4ff 0%, #f8fafc 50%, #fff7ed 100%)' }}>
      <div className="absolute inset-0 bg-gradient-to-r from-purple-50/50 via-transparent to-orange-50/30" />
...
function ReasonCard({ reason, index }: { reason: typeof reasons[0]; index: number }) {
  ...
  return (
    <div
      ...
      className={`group bg-white border border-gray-200 rounded-2xl p-6 hover:border-primary-500/40 transition-all duration-500 hover:-translate-y-1 hover:shadow-xl ${
    ...
    >
      ...
      <h3 className="font-heading font-bold text-gray-900 text-lg mb-2">{reason.title}</h3>
